let roleUpgrader =
{
    defaultStrat: function(creep){
        ...
        if(creep.room.controller.level >= 2 && creep.room.find(FIND_MY_CONSTRUCTION_SITES).length > 0 && _.filter(Game.creeps, (creeep) => (creeep.memory.role == 'upgrader' && creeep.room == creep.room)).length > Memory.workerNum * 1.5){
